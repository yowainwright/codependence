...
export function Footer() {
  return (
    <footer className="w-full px-4 sm:px-6 md:px-10 xl:px-28 py-6 sm:py-7 border-t border-surface-raised flex flex-col gap-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center font-sans">
