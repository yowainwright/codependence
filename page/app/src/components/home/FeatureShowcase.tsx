...
const features: Feature[] = [
  {
    title: "Policy Drift",
    description:
      "Compare manifest versions against pinned policy and show exactly which packages drifted.",
    visual: <PolicyVisual />,
  },
  {
    title: "Version Control",
    description:
      "Keep selected packages pinned while update mode applies the versions policy allows.",
    visual: <VersionControlVisual />,
  },
  {
    title: "Monorepo Policy",
    description:
      "Resolve root and package policy across workspaces without flattening every package to one rule.",
    visual: <MonorepoVisual />,
  },
  {
    title: "Node API",
    description:
      "Call the same check engine from release scripts, bots, or custom repository tooling.",
    visual: (
      <CodeVisual
        title="node-api.ts"
        lines={[
  ...
  },
  {
    ...
    description:
      "Run the same command in CI and fail the job when dependency policy drifts.",
    visual: (
      <CodeVisual
        title="GitHub Actions"
        lines={[
          "Run bunx codependence --update --dryRun",
  ...
  },
  {
    ...
    description:
      "Request JSON or Markdown when policy results need to feed PR comments and audit jobs.",
    visual: (
      <CodeVisual
...
function PolicyVisual() {
  return (
    <svg
      viewBox="0 0 360 170"
      role="img"
      aria-label="Policy check animation"
    ...
    >
      ...
      <text
        x="42"
        y="51"
        className="fill-base-content/70 text-[13px] font-semibold"
      >
        package.json
      </text>
      <text
      ...
      <text x="42" y="82" className="fill-base-content/60 text-[12px]">
        lodash 4.17.0
      </text>
      <text x="42" y="109" className="fill-base-content/60 text-[12px]">
        fs-extra 10.0.0
      </text>
      <text x="222" y="82" className="fill-base-content/60 text-[12px]">
        lodash 4.17.21
      </text>
      <text x="222" y="109" className="fill-base-content/60 text-[12px]">
        fs-extra 10.1.0
      </text>
      <path
      ...
      <text x="144" y="151" className="fill-error text-[12px] font-semibold">
        drift detected
      </text>
    </svg>
  );
...
function VersionControlVisual() {
  return (
    <svg
      viewBox="0 0 360 170"
      role="img"
      aria-label="Version control animation"
      className="h-full w-full"
    >
      <rect
        x="28"
      ...
      <rect
        ...
        height="30"
        rx="15"
        className="fill-base-200 stroke-base-content/10"
      />
      <text x="64" y="104" className="fill-base-content/70 text-[12px]">
        4.17.0
      </text>
      <path
        d="M148 99 H212"
      ...
      <rect
        ...
        className="fill-base-200 stroke-base-content/10"
      />
      <text x="241" y="104" className="fill-base-content/70 text-[12px]">
        4.17.21
      </text>
      <text x="127" y="128" className="fill-warning text-[12px] font-semibold">
        Pinned ■
      </text>
    </svg>
  );
...
function MonorepoVisual() {
  return (
    <svg
      viewBox="0 0 360 170"
      role="img"
      aria-label="Monorepo policy animation"
      className="h-full w-full"
    >
      ...
      <g>
        <circle
          ...
          cy="56"
          r="28"
          className="fill-base-100 stroke-cyan-400"
          strokeWidth="2"
        />
        <text
          x="160"
          y="61"
          className="fill-base-content/70 text-[12px] font-semibold"
        >
          root
        </text>
      </g>
