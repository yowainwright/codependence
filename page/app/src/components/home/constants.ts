...
export const CODE_SNIPPETS: CodeSnippet[] = [
  {
    ...
    lines: [
      ...
      { text: "\n\n", color: "" },
      { text: "Policy: ", color: "text-foreground/70" },
      { text: ".codependencerc", color: "text-primary" },
      { text: "\nStrategy: ", color: "text-foreground/70" },
      { text: "permissive", color: "text-accent" },
      { text: " (pin listed, update the rest)", color: "text-foreground/50" },
      { text: "\nFiles: ", color: "text-foreground/70" },
  ...
  },
  {
    ...
    title: "Config",
    lines: [
      { text: "\u002f\u002f .codependencerc", color: "text-foreground/50" },
      { text: "\n", color: "" },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "\n", color: "" },
      { text: "\nCI result: ", color: "text-foreground/70" },
  ...
  },
  {
    ...
    lines: [
      { text: "$ ", color: "text-secondary" },
      { text: "codependence --update", color: "text-foreground" },
      { text: "\n\n", color: "" },
      { text: "Applying version policy...", color: "text-foreground/70" },
      { text: "\n\n", color: "" },
      ...
      { text: " dependencies in ", color: "text-foreground" },
