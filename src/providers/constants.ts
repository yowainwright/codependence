...
export const NODE_PACKAGE_MANAGER_LOCKFILES = {
  ...
  [NODE_PACKAGE_MANAGERS.PNPM]: [MANIFEST_FILES.PNPM_LOCK, MANIFEST_FILES.PNPM_WORKSPACE],
...
export const DEFAULT_LANGUAGE_MANIFESTS = {
  [LANGUAGES.CIRCLECI]: [MANIFEST_FILES.CIRCLECI_CONFIG_YML, MANIFEST_FILES.CIRCLECI_CONFIG_YAML],
  [LANGUAGES.DOCKER]: [
